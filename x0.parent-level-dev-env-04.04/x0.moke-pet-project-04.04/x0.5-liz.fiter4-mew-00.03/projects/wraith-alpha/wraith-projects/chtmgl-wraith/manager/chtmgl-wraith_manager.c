...
void resolve_paths() {
    ...
    snprintf(project_session_dir, sizeof(project_session_dir),
             "%s/projects/wraith-alpha/wraith-projects/chtmgl-wraith/session", project_root);
...
void trigger_initial_render() {
    ...
    snprintf(op_path, sizeof(op_path),
             "%s/projects/wraith-alpha/wraith-projects/chtmgl-wraith/ops/+x/wraith_project_input.+x", project_root);
    ...
    if (pid == 0) {
        ...
        snprintf(project_dir, sizeof(project_dir),
                 "%s/projects/wraith-alpha/wraith-projects/chtmgl-wraith", project_root);
...
int main() {
    ...
    log_debug("CHTMGL Wraith Manager Started");
    ...
    log_debug("CHTMGL Wraith Manager init complete (hot path owned by ops/wraith_project_input.c)");
