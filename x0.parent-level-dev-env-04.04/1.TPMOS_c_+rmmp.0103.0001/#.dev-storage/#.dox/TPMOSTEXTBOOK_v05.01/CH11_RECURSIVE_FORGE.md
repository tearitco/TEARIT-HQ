...
*   **In-Game Editor:** Players can use a simplified `op-ed` *within the game* to author controller logic, swap bot behavior, and program the bot's PAL loop. This creates a recursive loop: you are playing a game about a bot that is also learning how to behave. 🤖🎮
