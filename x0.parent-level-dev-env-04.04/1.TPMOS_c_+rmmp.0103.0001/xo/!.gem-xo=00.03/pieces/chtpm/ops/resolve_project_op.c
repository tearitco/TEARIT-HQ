...
int main(int argc, char *argv[]) {
    ...
    if (entry_layout[0] == '\0') {
        if (strcmp(name, "op-ed") == 0) strcpy(entry_layout, "projects/op-ed/layouts/op-ed.chtpm");
        else if (strcmp(name, "man-ops") == 0) strcpy(entry_layout, "pieces/apps/man-ops/layouts/man-ops.chtpm");
        else if (strcmp(name, "fuzz-op") == 0) strcpy(entry_layout, "projects/fuzz-op/layouts/fuzz-op.chtpm");
        else snprintf(entry_layout, sizeof(entry_layout), "projects/%s/layouts/%s.chtpm", name, name);
    }
