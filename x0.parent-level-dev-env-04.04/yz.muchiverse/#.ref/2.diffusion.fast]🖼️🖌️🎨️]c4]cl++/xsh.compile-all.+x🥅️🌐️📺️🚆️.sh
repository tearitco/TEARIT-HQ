...
for file in *.c; do
    ...
    gcc "$file" -o "$output_dir/$executable_name" -pthread -lm -lssl -lcrypto -lGL -lGLU -lglut -lfreetype -lavcodec -lavformat -lavutil -lswscale  -lX11 -I/usr/include/freetype2 -I/usr/include/libpng12 -L/usr/local/lib -I/usr/include -L/usr/lib -lOpenCL
