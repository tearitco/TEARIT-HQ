...
RENDER_BIN="$HOUSE/_.monads/_.livedesk-taskbar/ops/+x/khtpm_core_render.+x"
WATCHER_BIN="$HOUSE/_.monads/_.livedesk-taskbar/ops/+x/khtpm_desktop_trigger_watcher.+x"
