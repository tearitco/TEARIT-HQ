...
"})();\n"
"/* ---- rung 3b: Event subclasses (2026-09-21): KeyboardEvent/InputEvent/...\n"
"/* ---- were empty constructors (C class_noop) so `new KeyboardEvent('key')`\n"
"/* ---- had no .type -> dispatch_event bailed before firing listeners and the\n"
"/* ---- whole typed-input path was dead. Wire each as a subclass of the real\n"
"/* ---- Event (type/bubbles/cancelable via Event.call) + own init keys. ---- */\n"
"(function(){\n"
"  var g=(typeof globalThis!=='undefined')?globalThis:window;\n"
"  var BE=function(){ try{ return window.Event; }catch(e){ return null; } }();\n"
"  if (!BE) return;\n"
"  function wireSub(name, keys){\n"
"    try{\n"
"      if (typeof g[name] !== 'undefined') return;\n"
"      function C(type, opts){\n"
"        BE.call(this, type, opts);\n"
"        var o=opts||{};\n"
"        for (var i=0;i<keys.length;i++){ var k=keys[i]; if (k in o) this[k]=o[k]; }\n"
"        return this;\n"
"      }\n"
"      C.prototype=Object.create(BE.prototype);\n"
"      C.prototype.constructor=C;\n"
"      Object.defineProperty(g,name,{ value:C, configurable:true, writable:true });\n"
"    }catch(e){}\n"
"  }\n"
"  wireSub('KeyboardEvent',['key','code','charCode','keyCode','which','ctrlKey','shiftKey','altKey','metaKey','repeat','isComposing','location']);\n"
"  wireSub('InputEvent',['data','inputType','isComposing','dataTransfer']);\n"
"  wireSub('MouseEvent',['button','buttons','clientX','clientY','offsetX','offsetY','screenX','screenY','ctrlKey','shiftKey','altKey','metaKey','relatedTarget']);\n"
"  wireSub('FocusEvent',['relatedTarget']);\n"
"  wireSub('PointerEvent',['pointerId','pointerType','isPrimary','pressure','clientX','clientY']);\n"
"  wireSub('TouchEvent',['touches','targetTouches','changedTouches']);\n"
"  wireSub('WheelEvent',['deltaX','deltaY','deltaZ','deltaMode']);\n"
"  wireSub('UIEvent',['view','detail']);\n"
"  wireSub('DragEvent',['dataTransfer']);\n"
"  wireSub('ProgressEvent',['lengthComputable','loaded','total']);\n"
"  wireSub('ErrorEvent',['message','filename','lineno','colno','error']);\n"
"  wireSub('MessageEvent',['data','origin','lastEventId','source','ports']);\n"
"  wireSub('CustomEvent',['detail']);\n"
"  wireSub('AnimationEvent',['animationName','elapsedTime']);\n"
"  wireSub('TransitionEvent',['propertyName','elapsedTime']);\n"
"})();\n"
"\n"
...
"})();\n"
"\n"
"/* ---- Image + document.createEvent (row-31 through-manager run): ---- */\n"
"/* ---- closure base.js feature-detects document.createEvent('Event') + ---- */\n"
"/* ---- initEvent + preventDefault/defaultPrevented; youtube's inline ---- */\n"
"/* ---- ytPrewarmYtimg does `new Image().src = …`. ---- */\n"
"(function(){\n"
"  if (typeof window.Image === 'undefined'){\n"
"    function Image(w,h){ this.src=''; this.width=w||0; this.height=h||0; this.complete=false; this.naturalWidth=0; this.naturalHeight=0; this.onload=null; this.onerror=null; this.crossOrigin=null; }\n"
"    Object.defineProperty(window,'Image',{ value:Image, configurable:true, writable:true });\n"
"  }\n"
"  var d=window.document;\n"
"  if (d && !d.createEvent){\n"
"    d.createEvent=function(kind){\n"
"      var e=new window.Event('');\n"
"      e.initEvent=function(type,bubbles,cancelable){ this.type=String(type||''); this.bubbles=!!bubbles; this.cancelable=!!cancelable; this.defaultPrevented=false; return this; };\n"
"      e.initCustomEvent=function(type,bubbles,cancelable,detail){ this.type=String(type||''); this.bubbles=!!bubbles; this.cancelable=!!cancelable; this.detail=detail; this.defaultPrevented=false; return this; };\n"
"      return e;\n"
"    };\n"
"  }\n"
"})();\n"
"\n"
"/* ---- NodeFilter constants for document.createTreeWalker (row-31). ---- */\n"
"(function(){\n"
"  var g=(typeof globalThis!=='undefined')?globalThis:window;\n"
"  if (typeof g.NodeFilter === 'undefined'){\n"
"    g.NodeFilter={SHOW_ALL:0xFFFFFFFF,SHOW_ELEMENT:1,SHOW_ATTRIBUTE:2,SHOW_TEXT:4,SHOW_CDATA_SECTION:8,SHOW_ENTITY_REFERENCE:16,SHOW_ENTITY:32,SHOW_PROCESSING_INSTRUCTION:64,SHOW_COMMENT:128,SHOW_DOCUMENT:256,SHOW_DOCUMENT_TYPE:512,SHOW_DOCUMENT_FRAGMENT:1024,SHOW_NOTATION:2048,FILTER_ACCEPT:1,FILTER_REJECT:2,FILTER_SKIP:3};\n"
"  }\n"
