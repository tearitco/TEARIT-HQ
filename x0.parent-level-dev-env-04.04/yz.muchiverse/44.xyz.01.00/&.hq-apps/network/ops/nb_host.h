...
/* Rung 6 prelude: URL/URLSearchParams/history/matchMedia/getComputedStyle/
 * MutationObserver/atob/btoa/timers/document.cookie. Evaluated once just
 * before the page script. See nb_js_eval.c's comments for provenance. */
