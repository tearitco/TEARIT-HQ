 ...
 * frame_history.txt entry) entirely when it doesn't - avoids a
 * needless scroll/flicker on a spurious or duplicate pulse. */
#define _GNU_SOURCE
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(void) {
     ...
     * marker (see this file's own top-of-file comment). */
