...
void render_emoji(const char *emoji, float x, float y, float z) {
    ...
    // Render the texture
    glBegin(GL_QUADS);
    glTexCoord2f(0.0, 1.0); glVertex3f(x2, y2, 0.0f);
    glTexCoord2f(1.0, 1.0); glVertex3f(x2 + w, y2, 0.0f);
    glTexCoord2f(1.0, 0.0); glVertex3f(x2 + w, y2 + h, 0.0f);
    glTexCoord2f(0.0, 0.0); glVertex3f(x2, y2 + h, 0.0f);
    glEnd();
