# PHYMOJI — piececraft-xyz's own real-object voxel-entity standard
...
is the *adoption plan* for piececraft-xyz specifically, not a
...
**Phymoji = piececraft-xyz's own real objects** (trees, later mountains/
...
## 2. Real pipeline, mapped onto piececraft-xyz's own actual code
