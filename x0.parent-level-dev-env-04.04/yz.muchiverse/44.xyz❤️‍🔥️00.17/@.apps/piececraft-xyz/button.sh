#!/bin/bash
# button.sh - launcher for piececraft-xyz, modeled directly on
...
# House root - two levels up from this project (piececraft-xyz is
...
# per-host ("board-viewer:piececraft-xyz", see &.widgits/board-viewer/
...
case "$ACTION" in
    ...
    run|r|start)
        ...
        # logic) to find &.widgits/ and piececraft-xyz's own REAL
...
EOSTATE
    ...
    help|h|-h|--help)
        ...
        echo "  kill, k, stop       - Kill any lingering piececraft-xyz processes"
