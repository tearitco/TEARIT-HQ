# PROMPT — SP-IRL (Tactical Monsters)

**Self-contained freeglut + C.** Tactics-style monster battler evolving from a GBC Pokémon clone.
Target: grid-based overworld battles (FFT/Disgaea-style) with real-time exploration and turn-based combat on the same screen.
