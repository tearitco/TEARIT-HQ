...
- `2026-09-23/notes.md` — Actors 5–11 on the live list; TPMOS-style frame log for db-hq-pal; three open issues (no add-actor control, arrows move the tab strip, `db_hq_history.txt` does not drive this window).
