...
4. This house is BASH/C-op-and-manager shaped, not a generic scripting
   ...
   `44.xyz.01.00/!.HOUSE_STDS.md` before writing anything, and match
...
4. **The real precedent to copy the manager's SHAPE from, not just read
   ...
   `44.xyz.01.00/101.lpns+map+4/system/game_manager.c` (same house
...
the real one is `44.xyz.01.00/101.lpns+map+4/system/game_manager.c`,
...
**Read `44.xyz.01.00/#.ref/menu/EVENT-COMMAND-REGISTRY-ARCHITECTURE.md`
