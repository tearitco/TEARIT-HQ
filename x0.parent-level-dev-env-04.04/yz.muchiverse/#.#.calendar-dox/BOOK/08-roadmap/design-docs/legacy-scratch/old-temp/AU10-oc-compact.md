...
- Rebuild from house root `…/44.xyz.01.00`: `gcc -std=c11 -Wall -O2 "&.widgits/livedesk-taskbar/ops/tp_taskbar.c" -o "&.widgits/livedesk-taskbar/ops/+x/tp_taskbar.+x" -lX11`; pre-existing `-Wformat-truncation`/unused-var warnings are noise.
