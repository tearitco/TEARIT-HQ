...
BASE_DIR = SCRIPT_DIR
OUTPUT_PDF = os.path.join(SCRIPT_DIR, "TPMOS_TEXTBOOK_v05.01.pdf")
...
class TPMOS_PDF(FPDF):
    def header(self):
        if self.page_no() > 1:
            ...
            header_text = clean_emojis("📚 TPMOS TEXTBOOK v05.01 🎓  ")
...
def create_pdf():
    ...
    pdf.cell(0, 10, "Version 05.01 (Exo-Sovereignty Edition)", align="C", new_x=XPos.LMARGIN, new_y=YPos.NEXT)
    pdf.ln(80)
