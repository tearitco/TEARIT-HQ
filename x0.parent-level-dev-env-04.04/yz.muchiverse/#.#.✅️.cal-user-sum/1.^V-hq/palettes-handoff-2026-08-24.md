...
| `palettes_menu_1..11_label/cmd` PDL rows incl. trailing cancel | `44.xyz❤️‍🔥️00.17/#.desktop/livedesk_taskbar.pdl` | published rows visible in `#.desktop/strip_var_hqitems.txt` after open; cancel dismisses w/o launching |
...
| `CREATOR_AGENT.md` two-systems map + INDEX links | `#.#.✅️.cal-user-sum/1.^V-hq/` | this doc's prerequisite |
