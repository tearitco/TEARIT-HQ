...
Real cell source: `44.xyz❤️‍🔥️00.17/#.desktop/livedesk_taskbar.pdl` (labels/
commands, editable without recompile) dispatched by
`44.xyz❤️‍🔥️00.17/*.monads/*.livedesk-taskbar/ops/khtpm_taskbar_manager.c`.
Launcher targets for HQ-menu rows resolve via
`44.xyz❤️‍🔥️00.17/#.desktop/livedesk_launchers.pdl`.
...
`44.xyz❤️‍🔥️00.17/&.widgits/events-hq/ops/khtpm_events_hq_manager.c` — a
...
`44.xyz❤️‍🔥️00.17/&.widgits/palettes/pallets.pdl` and
...
reactivity columns) at `44.xyz❤️‍🔥️00.17/#.ref/menu/palletes/
chemistry_tiles_expanded🏆.csv`, rendered via `publish_elements()` in
`44.xyz❤️‍🔥️00.17/*.monads/*.livedesk-taskbar/ops/palettes_manager.c`
(line ~194, `g_source_path` set at line ~244) into
`44.xyz❤️‍🔥️00.17/&.widgits/palettes/palettes-elements.chtpm`. Today this
...
directory `44.xyz❤️‍🔥️00.17/@.app-store` is an empty scaffold with only
...
`44.xyz❤️‍🔥️00.17/net/ollama-lan.pdl` + `net/qwen.sh`) but it is
...
Located at `44.xyz❤️‍🔥️00.17/101.mutaclsym🧟‍♂️️19.00/` (an active dir; an
...
`44.xyz❤️‍🔥️00.17/&.widgits/open-hai/ops/launch_h_ai.sh`, which runs
`khtpm_open_hai_render.c` + `khtpm_open_hai_manager.c`. The manager makes
a REAL local inference call: `send_to_ollama()` in
`44.xyz❤️‍🔥️00.17/&.widgits/open-hai/ops/khtpm_open_hai_manager.c`
...
`44.xyz❤️‍🔥️00.17/&.hq-apps/chat-hai/`, whose real engine is
...
- Real personas (4 regular chatters + 1 moderator) live as `.pdl` files:
  `44.xyz❤️‍🔥️00.17/&.hq-apps/chat-hai/pieces/personas/{bravo,moxie,pip,
...
These live at `44.xyz❤️‍🔥️00.17/@.apps/my-biotech/` and `@.apps/my-lawyer/`,
