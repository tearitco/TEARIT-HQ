...
`44.xyz❤️‍🔥️00.17/%.harnesses/install-xyzos/button.sh` - `compile` builds
...
Real, existing house rule: `44.xyz❤️‍🔥️00.17/#.WIN-COMPAT-RULE.md` -
...
tracking: `44.xyz❤️‍🔥️00.17/#.WIN-CONVERSION-STATUS.md` (not read this
session - check its own real current state before assuming anything
about Windows readiness). Real user-facing doc:
`44.xyz❤️‍🔥️00.17/windows-house-guide.md`. No Mac-specific rule file was
